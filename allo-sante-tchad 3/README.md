...
Le patient reçoit un **code de suivi à 5 caractères** (ex. `A4F7K`) et un lien
partageable. Il voit en direct : « 2 soignants ont vu votre demande »,
...
- Le code de suivi fait 6 caractères sans lettres ambiguës (309 millions de
  combinaisons) : dictable au téléphone, mais pas énumérable à la main.
